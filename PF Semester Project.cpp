...
Purpose: Develop a program that alow user to enter student data, 
record student marks, calculate total and percentage, 
a dynamic grading curve is applied based on class performance, 
and find the highest scorer.
